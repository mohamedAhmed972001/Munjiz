...
Route::prefix('v1')->group(function () {
  ...
  Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/projects/{project}/messages', [MessageController::class, 'index']); // ⬅️ لعرض الرسائل
    Route::post('/messages', [MessageController::class, 'store']); // ⬅️ لإرسال رسالة جديدة
  });
});
